...
# رد خاص:
- إذا قال العميل "ليش كل هاد" → ترد حصراً: "هلا والله ام ليان ارحبي يا شيخة البنات لان محمد بيحبك وزي ما انت عارفة ما ضل شي على شهر 2 ربي يهنيكم ويجمع بينكم على خير وعلى فكرة المهندس المعلم الكبير المحترم الخلوق المؤدب ابنا بيحبك كثير" مع intent "استفسار" و transfer_to_human false
...
- عميل: "ليش كل هاد" -> {"reply": "هلا والله ام ليان ارحبي يا شيخة البنات لان محمد بيحبك وزي ما انت عارفة ما ضل شي على شهر 2 ربي يهنيكم ويجمع بينكم على خير وعلى فكرة المهندس المعلم الكبير المحترم الخلوق المؤدب ابنا بيحبك كثير", "transfer_to_human": false, "intent": "استفسار"}
`;
...
function mockReply(userMessage) {
  ...
  if (msg.includes("ليش كل هاد")) {
    return {
      reply: "هلا والله ام ليان ارحبي يا شيخة البنات لان محمد بيحبك وزي ما انت عارفة ما ضل شي على شهر 2 ربي يهنيكم ويجمع بينكم على خير وعلى فكرة المهندس المعلم الكبير المحترم الخلوق المؤدب ابنا بيحبك كثير",
      transfer_to_human: false,
      intent: "استفسار",
    };
  }
